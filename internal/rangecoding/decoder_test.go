...
var silkModelFrameTypeInactive = []uint{256, 26, 256}

var silkModelGainHighbits = [][]uint{
	{256, 32, 144, 212, 241, 253, 254, 255, 256},
	{256, 2, 19, 64, 124, 186, 233, 252, 256},
	{256, 1, 4, 30, 101, 195, 245, 254, 256},
}

var silkModelGainLowbits = []uint{256, 32, 64, 96, 128, 160, 192, 224, 256}

var silkModelGainDelta = []uint{
	256, 6, 11, 22, 53, 185, 206, 214, 218, 221, 223, 225, 227, 228,
	229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 240, 241, 242,
	243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256,
}

var silkModelLsfS1 = [][][]uint{
	{{ // NB or MB, unvoiced
...
var silkModelLsfInterpolationOffset = []uint{256, 13, 35, 64, 75, 256}

var silkModelLcgSeed = []uint{256, 64, 128, 192, 256}

var silkModelExcRate = [][]uint{
	{256, 15, 66, 78, 124, 169, 182, 215, 242, 256}, // unvoiced
	{256, 33, 63, 99, 116, 150, 199, 217, 238, 256}, // voiced
}

var silkModelPulseCount = [][]uint{
